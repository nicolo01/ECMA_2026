...
We select the predictor variables: selezioniamo i potenziali predittori che permettono di prevedere il prezzo delle case, scegliamo le più importanti per spiegare il prezzo delle case.
...
questo era il primo metodo "a monte".....poi possiamo fittare un modello lineare che consideri tutte le variabili e mi dia il suo summary.
